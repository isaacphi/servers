...
import { Tool, GDriveReadFileInput, InternalToolResponse } from "./types.js";
...
async function readGoogleDriveFile(fileId: string): Promise<{ name: string, contents: FileContent }> {
