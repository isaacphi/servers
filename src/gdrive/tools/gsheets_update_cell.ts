...
import { Tool, GSheetsUpdateCellInput, InternalToolResponse } from "./types.js";
...
export async function updateCell(args: GSheetsUpdateCellInput): Promise<InternalToolResponse> {
